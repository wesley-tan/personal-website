...
var React = _interopRequireWildcard(__webpack_require__(2374));
...
var _scrollHandler = __webpack_require__(1432);
var _react = __webpack_require__(2374);
...
var _react = _interopRequireDefault(__webpack_require__(2374));
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2374);
...
// EXTERNAL MODULE: external "/Users/wesleysimeontan/personal-website-clone/node_modules/react/index.js"
var index_js_ = __webpack_require__(2374);
...
const React=__webpack_require__(2374);const{grabMatchParams}=__webpack_require__(9755);const{StaticQueryContext}=__webpack_require__(7076);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9706);const{ServerLocation,Router}=__webpack_require__(7896);const{renderToString}=__webpack_require__(9378);const{parse}=__webpack_require__(698);const styleToOjbect=__webpack_require__(7848);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(2374),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/Users/wesleysimeontan/personal-website-clone/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/wesleysimeontan/personal-website-clone/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/wesleysimeontan/personal-website-clone/node_modules/react/index.js");
...
const React=__webpack_require__(2374);const path=__webpack_require__(1423);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(9378);const{ServerLocation,Router,isRedirect}=__webpack_require__(7896);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7076);const fs=__webpack_require__(1907);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const{headHandlerForSSR}=__webpack_require__(923);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(8995);const{ServerSliceRenderer}=__webpack_require__(7529);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
